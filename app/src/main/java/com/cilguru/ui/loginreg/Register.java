...
public class Register extends AppCompatActivity {
    ...
    private Context myContext = Register.this;
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if (task.isSuccessful()){
                               ...
                               // String img= mAuth.getCurrentUser().getPhotoUrl().toString();
                                ...
                                storeDefaultDatabaseReference.child("user_dob").setValue("");
                                ...
                                storeDefaultDatabaseReference.child("user_image").setValue("img"); // Original image
                                storeDefaultDatabaseReference.child("device_token").setValue(deviceToken);
                                storeDefaultDatabaseReference.child("user_thumb_image").setValue("img")
