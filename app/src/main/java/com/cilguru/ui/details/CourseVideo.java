...
public class CourseVideo extends AppCompatActivity implements RecyclerAdaptertv.OnItemClickListener, View.OnClickListener {
...
//        mProgressBar = root.findViewById(R.id.myDataLoaderProgressBar);
        ...
        mTvdt = new ArrayList<>();
        mAdapter = new RecyclerAdaptertv(this, mTvdt);

        mRecyclerView.setAdapter(mAdapter);
        mAdapter.setOnItemClickListener(CourseVideo.this);
...
//                final Dialog dialog = new Dialog(CourseVideo.this);
...
////                    @Override
////                    public void onClick(View v) {
////                        Intent intent = new Intent(CourseVideo.this, SendActivity.class);
                 ...
                 //   map.put(key,value);
                        ...
                        mDBListener = mDatabaseRef.addValueEventListener(new ValueEventListener() {
                            ...
                            public void onCancelled(DatabaseError databaseError) {
                                Toast.makeText(CourseVideo.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                                mShimmer.setVisibility(View.INVISIBLE);
                                Toast.makeText(CourseVideo.this,"No Data Found",Toast.LENGTH_SHORT).show();
                            }
                        });
...
//                }
    ...
    private void loadpay() {
        ...
        qalk.addValueEventListener(new ValueEventListener() {
           ...
           Toast.makeText(CourseVideo.this, mDatabaseRef.toString(), Toast.LENGTH_SHORT).show();
    }
    ...
    private void unpdmssg() {
        ...
        txtmsg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CourseVideo.this, MainActivity.class);
                startActivity(intent);
            }
        });
        cross.setOnClickListener(new View.OnClickListener() {
...
//    }
    ...
    private void openDetail(String[] data) {
        Intent intent = new Intent(CourseVideo.this, ShopDetail.class);
